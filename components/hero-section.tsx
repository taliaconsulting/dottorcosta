    ...
    <section id="hero" className="p-2 sm:p-3 lg:p-4 h-screen">
      <div className="relative w-full h-full min-h-[calc(100vh-2rem)] rounded-2xl overflow-hidden flex items-center justify-center bg-none">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blu-notte/90 via-blu-notte/50 to-blu-notte/90" />
        </div>
        ...
        <div className="container relative z-10 py-20 mt-16">
          <div className="flex flex-col items-center text-center text-white space-y-8">
            ...
            <p className="text-xl sm:text-2xl font-light tracking-wide text-bianco-perla/80 uppercase">
            ...
            <div className="mt-8">
              <p className="text-lg sm:text-xl text-bianco-perla/90">
                ...
                {data?.locationLink && (
                  <a href="#" className="underline underline-offset-4 hover:text-bianco-perla/70 transition-colors">
                    {data.locationLink}
                  </a>
                )}
              </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              {data?.phoneNumber && (
                <Button
                  size="lg"
                  variant="outline"
                  className="h-12 px-8 bg-bianco-perla text-blu-notte hover:bg-bianco-perla/90 border-0 transition-colors"
                >
                  {data.phoneNumber}
                </Button>
              )}
